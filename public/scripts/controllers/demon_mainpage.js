...
//myStrangerThingsApp.controller('DEMainPageCtrl', function($scope, $location, $http, socket, ngDialog, $window) {
myStrangerThingsApp.controller('DEMainPageCtrl', function($scope, $location, $http, $window) {
console.log("DEMainPageCtrl:",$scope);
...
//console.log("week="+week);
	...
	$scope.characterName					= "Eleven";  //Tony will put one hand behind his back to reduce his powers to the level of Eleven
...
//        console.log("MainPageCtrl loaded");
				$scope.searchTheLab(2); //let's start searching on the 2nd floor
